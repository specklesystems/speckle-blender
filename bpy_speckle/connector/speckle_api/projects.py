...
def get_projects_for_account(
    ...
    try:
        ...
        if workspace_id:
            ...
            projects_with_permissions = client.workspace.get_projects_with_permissions(
        ...
        return _get_projects_with_individual_permissions(client, workspace_id, search)
...
def get_project_workspace_id(client: SpeckleClient, project_id: str) -> Optional[str]:
    """Resolve a project's workspace id, on servers new enough to have one."""
    workspace_id = None
